...
export const workTime = [
  ...
  { id: 'EVENING', label: '저녁 (18:00~22:00)' },
  { id: 'NIGHT', label: '심야 (22:00~02:00)' },
...
export const sido = [
  ...
  { id: 'SEJEONG', label: '세종특별자치시' },
  { id: 'CHUNGCHEONGBUK', label: '충청북도' },
  { id: 'CHUNGCHEONGNAM', label: '충청남도' },
  { id: 'DAEGU', label: '대구광역시' },
  { id: 'ULSAN', label: '울산광역시' },
  { id: 'BUSAN', label: '부산광역시' },
  { id: 'GYEONGSANGBUK', label: '경상북도' },
  { id: 'GYEONGSANGNAM', label: '경상남도' },
  { id: 'GWANGJU', label: '광주광역시' },
  { id: 'JEONBUK', label: '전북특별자치도' },
  { id: 'JEONLLANAM', label: '전라남도' },
