  ...
  return (
    <AnimatePresence>
      ...
      {isOpen && (
        <>
          <motion.div
            className="fixed bottom-0 left-0 right-0 top-[7rem] z-40 bg-black/40 sm:hidden"
            onClick={close}
          ...
          <motion.aside
            className="fixed left-0 top-[7rem] z-50 h-full w-[29rem] max-w-[30rem] bg-white sm:hidden"
            // 애니메이션 상태를 정의합니다.
