...
const HeaderNotification = ({ isOpen, onClose }: HeaderNotificationProps) => {
  ...
  useModal({
    isOpen: isOpen && windowWidth <= 360,
    onClose: () => {
      if (windowWidth <= 360) return;
      onClose();
    },
  });
  ...
  return (
    <div>
      <ModalOverlay onClose={onClose} className="sm:hidden" />
      <div className="absolute right-[-4.4rem] top-[5rem] flex h-[38.2rem] w-[32.4rem] flex-col gap-[2rem] rounded-[1.2rem] bg-black-10 px-[2rem] pb-[3rem] pt-[2.2rem] shadow-pop sm:right-0">
        ...
        <div className="flex h-[28rem] w-[29rem] flex-col gap-[1.2rem] overflow-y-auto overflow-x-hidden">
          <div className="flex flex-col gap-[0.6rem]">
            ...
            <div className="flex w-[29rem] flex-col gap-[0.4rem]">
              <div className="flex h-[3.8rem] w-full cursor-pointer items-center rounded-[0.6rem] bg-black-10 px-[1rem] hover:bg-primary-10">
                <div className="flex w-full gap-[0.6rem]">
                  ...
                  <span className="truncate text-body-14_M500 text-black-70">
                    세계 최초 반려동물 브리더 입양 플랫폼을 함께 만들어가실
                    개발자 팀원을 구합니다
                  </span>
                </div>
              </div>
              ...
              <div className="flex h-[3.8rem] w-full cursor-pointer items-center rounded-[0.6rem] bg-black-10 px-[1rem] hover:bg-primary-10">
                <div className="flex w-full gap-[0.6rem]">
                  ...
                  <span className="truncate text-body-14_M500 text-black-70">
                    든든한 동료 있음! 초기 세팅, 와이어프레임 완료. 함께 웹
                    구현할 개발자를 찾습니다.
                  </span>
                </div>
              </div>
