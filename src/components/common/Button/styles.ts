...
export const BUTTON_SIZE_STYLES: Record<ButtonSize, string> = {
  ...
  lg: 'h-[4.4rem] px-[3.2rem] text-title-16_Sb600 rounded-[0.6rem] gap-[0.8rem]',
...
export const BUTTON_COLOR_STYLES: Record<ButtonColor, string> = {
  primary: 'bg-primary text-black-10 hover:bg-primary-80',
  secondary: 'bg-primary-10 text-primary-80 hover:bg-primary-20',
  tertiary: 'bg-black-10 text-black-130 hover:bg-black-30',
  quaternary: 'text-black-130 hover:bg-black-30 disabled:text-black-70',
};
