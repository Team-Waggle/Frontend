...
import {
  PostManagementApiItem,
  PostApplicantApiItem,
  PostMemberApiItem,
} from '../../types/ProfileApi';

const dummyData: {
  postManagement: PostManagementApiItem[];
  applicantManagement: PostApplicantApiItem[];
  memberManagement: PostMemberApiItem[];
} = {
  postManagement: [
    {
      id: '1',
...
const ProfilePosts = () => {
  const tabs = profileTabs.ProfilePosts;
  const [activeTab, setActiveTab] =
    useState<keyof typeof dummyData>('postManagement');
  ...
  useEffect(() => {
    ...
    const data =
      activeTab === 'postManagement'
        ? dummyData.postManagement
        : activeTab === 'applicantManagement'
          ? dummyData.applicantManagement
          : dummyData.memberManagement;
