...
// Api 처리하기 쉽도록 DummyData를 입력해뒀습니다.
const dummyData: {
  applied: AppliedApiItem[];
  joinProposal: JoinProposalApiItem[];
  joined: JoinedApiItem[];
} = {
  applied: [
    {
      id: '1',
      ...
      deadline: '00.00.00',
      industry: '소셜네트워크',
      title: '와글 팀과 함께할 디자이너, 기획자, 백엔드, 프론트엔드, 데브옵스님을 모집합니다.',
      skills: ['TypeScript'],
    },
  ],
  joinProposal: [
...
const ProfileApplications = () => {
  const tabs = profileTabs.ProfileApplications;
  const [activeTab, setActiveTab] = useState<keyof typeof dummyData>('applied');
